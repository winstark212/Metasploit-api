...
class MsfRpcMethod(object):
    ...
    ProAbout = 'pro.about'
    ProWorkspaces = 'pro.workspaces'
    ProProjects = 'pro.projects'
    ProWorkspacesAdd = 'pro.workspace_add'
    ProWorkspacesDel = 'pro.workspace_del'
    ProProjectsAdd = 'pro.project_add'
    ProProjectsDel = 'pro.project_del'
    ProUsers = 'pro.users'
    ProTaskList = 'pro.task_list'
    ProTaskStatus = 'pro.task_status'
    ProTaskStop = 'pro.task_stop'
    ProTaskLog = 'pro.task_log'
    ProTaskDeleteLog = 'pro.task_delete_log'
    ProStartDiscover = 'pro.start_discover'
    ProStartImport = 'pro.start_import'
    ProStartImportCreds = 'pro.start_import_creds'
    ProStartNexpose = 'pro.start_nexpose'
    ProStartProforce = 'pro.start_bruteforce'
    ProStartExploit = 'pro.start_exploit'
    ProStartWebScan = 'pro.start_webscan'
    ProStartWebAudit = 'pro.start_webaudit'
    ProStartWebExploit = 'pro.start_websploit'
    ProStartCleanUp = 'pro.start_cleanup'
    ProStartCollect = 'pro.start_collect'
    ProStartReport = 'pro.start_report'
    ProReportDownload = 'pro.report_download'
    ProReportDownloadByTask = 'pro.report_download_by_task'
    ProReportList = 'pro.report_list'
    ProStartExport = 'pro.start_export'
    ProExportList = 'pro.export_list'
    ProExportDownload = 'pro.export_download'
...
class MsfRpcClient(object):
    ...
    def __init__(self, password, **kwargs):
        ...
        self.port = kwargs.get('port', 3790)
...
class MsfProManager(MsfManager):
    @property
    def about(self):
        return self.rpc.call(MsfRpcMethod.ProAbout)
    ...
    def projects(self):
        ...
        List project
        """
        return self.rpc.call(MsfRpcMethod.ProProjects)
    ...
    def workspaces(self):
        ...
        List workspace
        """
        return self.rpc.call(MsfRpcMethod.ProWorkspaces)
    ...
    def users(self):
        ...
        List users
        """
        return self.rpc.call(MsfRpcMethod.ProUsers)
    ...
    def workspace_add(self, workspace):
        """
        Add worksapce
        """
        return self.rpc.call(MsfRpcMethod.ProProjectsAdd, workspace)

    def workspace_del(self):
        pass

    def start_discover(self, task):
        """
        Start discover network
        """
        return self.rpc.call(MsfRpcMethod.ProStartDiscover, task)

    def start_exploit(self, task):
        """
        Start exploit network
        """
        return self.rpc.call(MsfRpcMethod.ProStartExploit, task)

    def task_status(self, task_id):
        """
        Task status
        """
        return self.rpc.call(MsfRpcMethod.ProTaskStatus, task_id)

    def task_stop(self, task_id):
        """
        Stop task
        """
        return self.rpc.call(MsfRpcMethod.ProTaskStop, task_id)
    ...
    def task_list(self):
        ...
        Task list
        """
        return self.rpc.call(MsfRpcMethod.ProTaskList)

    def report_list(self, workspace_name):
        """
        report list
        """
        return self.rpc.call(MsfRpcMethod.ProReportList, workspace_name)

    def start_report(self, config):
        """
        Start report
        """
        return self.rpc.call(MsfRpcMethod.ProStartReport, config)

    def report_download(self, report_id):
        """
        Dowload report
        """
        return self.rpc.call(MsfRpcMethod.ProReportDownload, report_id)

    def report_download_by_task(self, task_id):
        """
        Download report by task
        """
        return self.rpc.call(MsfRpcMethod.ProReportDownloadByTask, task_id)

    def start_export(self, config):
        """
        Dowload report
        """
        return self.rpc.call(MsfRpcMethod.ProStartExport, config)
    ...
    def export_download(self, config):
        return self.rpc.call(MsfRpcMethod.ProExportDownload, config)
