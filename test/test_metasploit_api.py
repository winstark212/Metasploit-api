...
class MsfRpcClient(object):
    ...
    def __init__(self, password, **kwargs):
        ...
        self.sessionid = kwargs.get('token', '0f065b3c0f06331f2cbd311f359f3d21')
        if self.ssl:
            if self.verify_ssl:
        ...
        self.login(kwargs.get('username', 'metasploit'), password)
...
class MsfProManager(MsfManager):
    ...
    def start_discover(self, config):
        """
        Start discover network
        """
        return self.rpc.call(MsfRpcMethod.ProStartDiscover, config)
